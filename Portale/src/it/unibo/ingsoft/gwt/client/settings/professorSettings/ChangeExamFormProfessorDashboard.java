...
public class ChangeExamFormProfessorDashboard extends Composite {
	...
	public ChangeExamFormProfessorDashboard(Mainpage main) {
		this.mainpage = main;
		...
		depNameBox.addChangeHandler(new ViewCourses4UpdateExam());
		 ...
		 * DATA 
		 */
		Label dataLbl = new Label("Nuova data esame:");
		 ...
		 * ORA 
		 */
		Label oraLbl = new Label("Nuovo orario dell'esame:");
		 ...
		 * DUREZZA
		 */
		 Label durezzaLbl = new Label("Nuova difficolta' esame:");
		  ...
		  * AULA SVOLGIMENTO
		  */
		 Label aulaSvolgimentoLbl = new Label("Nuova aula esame:");
		 ...
		 * BUTTONS
		 */
		Button btnUpdate = new Button("UPDATE"); // Send exam's info to DB
	...
	private class ViewCourses4UpdateExam implements ChangeHandler {
	...
	private class UpdateInfoHandler implements ClickHandler{
		@Override
		public void onClick(ClickEvent event) {
			ProfessorFacade.getProfessorFacade().updateExamInfo(courseName, dataEsame, orarioEsame, durezzaEsame, aulaSvolgimento);
		}
