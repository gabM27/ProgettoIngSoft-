...
public class CreateExamFormProfessorDashboard extends Composite {
	...
	public CreateExamFormProfessorDashboard(Mainpage main) {
		this.mainpage = main;
		initWidget(this.mainPanel);
		/*
		 * panel : contiene tutti gli elementi necessari per aggiungere un nuovo esame.
