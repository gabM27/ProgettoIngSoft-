...
public class CreateChangeCourseFormProfessorDashboard extends Composite{
	...
	public CreateChangeCourseFormProfessorDashboard(Mainpage main) {
		...
		/*
		 * formPanel: contiene tutti gli elementi necessari per aggiungere o modificare i dati di un corso.
		 * buttonPanel: contiene tutti i bottoni.
		 */
		VerticalPanel formPanel = new VerticalPanel();
		HorizontalPanel buttonPanel = new HorizontalPanel();
		
		Label descriptionLbl = new Label("CREAZIONE / MODIFICA DI UN CORSO.");
		 ...
		 * CO-DOCENTE 
		 */
		Label coDocentLbl = new Label("Inserisci l'email del co-docente:");
