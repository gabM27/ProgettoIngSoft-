...
public class AddPersonalInfoFormStudentDashboard extends Composite {
	...
	public AddPersonalInfoFormStudentDashboard(Mainpage main) {
		this.mainpage = main;
		 ...
		 * iD (matricola)
		 */
		Label iDLbl = new Label("Numero di matricola dello studente:");
		TextBox iDTB = new TextBox();
		iDTB.setText("MATRICOLA");
		iDTB.addChangeHandler(new ChangeHandler() {
			@Override
			public void onChange(ChangeEvent event) {
				iDInput = iDTB.getText();
			}
		});
		/*
		 * Username
