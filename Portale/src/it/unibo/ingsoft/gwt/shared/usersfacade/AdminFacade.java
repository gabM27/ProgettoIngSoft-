...
//		Window.alert("WINDOW DEBUG: BEFORE SWITCH");
//		System.out.println("DEBUG: BEFORE SWITCH");
//		User user = null; 
//
//		if (typeAccount.equalsIgnoreCase("student")) {
//			user = new Student(email,pass);
//		} else if (typeAccount.equalsIgnoreCase("professor")) {
//			user = new Professor(email,pass);
//		} else if (typeAccount.equalsIgnoreCase("secretary")) {
//			user = new Secretary(email,pass);
//		} else {
//			System.out.println("C'E UN CAZZO DI PROBLEMA");
...
////			break;
////		}
//		Window.alert("WINDOW DEBUG: AFTER SWITCH");
//		System.out.println("DEBUG: AFTER SWITCH");
//		// Chiamo il server per aggiungere il nuovo account al database
//		Singleton.getGreetingService().addUserToDB(user, new AsyncCallback<String>() {
//			@Override
